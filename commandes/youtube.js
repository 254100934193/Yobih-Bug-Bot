...
zokou({
  ...
  try {
    ...
    if (_0x23da4f && _0x23da4f.length > 0x0) {
      const _0x4100df = await fetch("https://apis.davidcyriltech.my.id/download/ytmp4?url=" + encodeURIComponent(_0x516ed0.url");
...
zokou({
  ...
  try {
    ...
    if (_0x346271 && _0x346271.length > 0x0) {
      const _0x57c0e7 = await fetch("https://bandahealimaree-api-ytdl.hf.space/api/ytmp3?url=' + encodeURIComponent(_0x3341e1.url");
...
zokou({
  ...
  try {
    ...
    if (_0x18d954 && _0x18d954.length > 0x0) {
      const _0x316929 = await fetch("https://bandahealimaree-api-ytdl.hf.space/api/ytmp3?url=' + encodeURIComponent(_0x3341e1.url");

...
zokou({
  ...
  try {
    ...
    if (_0x128231 && _0x128231.length > 0) {
      ...
      const _0x302999 = await fetch("https://ab.cococococ.com/ajax/download.php?copyright=0&format=mp3&url=" + encodeURIComponent(_0x3ad715) + "&api=dfcb6d76f2f6a9894gjkege8a4ab232222");
...
zokou({
  ...
  try {
    ...
    if (_0x1d9a75 && _0x1d9a75.length > 0) {
      ...
      const _0x1c2fb5 = await fetch("https://ab.cococococ.com/ajax/download.php?copyright=0&format=mp3&url=" + encodeURIComponent(_0x3ad715) + "&api=dfcb6d76f2f6a9894gjkege8a4ab232222");
...
zokou({
  ...
  try {
    ...
    if (_0x3c942e && _0x3c942e.length > 0) {
      ...
      const _0x1f6f93 = await fetch("https://ab.cococococ.com/ajax/download.php?copyright=0&format=mp3&url=" + encodeURIComponent(_0x3ad715) + "&api=dfcb6d76f2f6a9894gjkege8a4ab232222");

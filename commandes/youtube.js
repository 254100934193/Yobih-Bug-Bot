...
zokou({
  ...
  try {
    ...
    if (_0x23da4f && _0x23da4f.length > 0x0) {
      const _0x4100df = await fetch("https://api.ibrahiadams.us.kg/api/download/ytmp4v2?url=" + encodeURIComponent(_0x10607f) + "&apikey=" + "ibraah-help");
...
zokou({
  ...
  try {
    ...
    if (_0x346271 && _0x346271.length > 0x0) {
      const _0x57c0e7 = await fetch("https://api.ibrahiadams.us.kg/api/download/ytmp3v2?url=" + encodeURIComponent(_0xc28c46) + "&apikey=" + "ibraah-help");
...
zokou({
  ...
  try {
    ...
    if (_0x18d954 && _0x18d954.length > 0x0) {
      const _0x316929 = await fetch("https://api.ibrahiadams.us.kg/api/download/ytmp3v2?url=" + encodeURIComponent(_0xc28c46) + "&apikey=" + "ibraah-help");

            ...
            if(ms.message.protocolMessage && ms.message.protocolMessage.type === 0 && (conf.ADM).toLocaleLowerCase() === 'yes' ) {
                ...
                if(ms.key.fromMe || ms.message.protocolMessage.key.fromMe) { console.log('Message supprimer me concernant') ; return }
                               ...
                               try {
                                ...
                                await zk.sendMessage(idBot,{ image : { url : './media/deleted-message.jpg'},caption : `        😈Anti-delete-message Detected,I'M MUNGAI😈\n Message from @${msg.key.participant.split('@')[0]}​` , mentions : [msg.key.participant]},)
                                .then( () => {
...
*You MAY read the group description FOR more info and Avoid getting removed,Feel At home Buddy We Love You 💚💚🤍.*
...
📌Powred by *YOBIH BOT MD*`;
            ...
            let msg = `Goodbye to that Fallen soldier,We'll miss that soldier💚 Powered by *YOBIH BUG BOT*;\n`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                let cmsg = `
*『YOBIH_BUG_BOT IS SUCCESSFULLY CONNECTED 』*
...
║❒ *YOUTUBE*
http://www.youtube.com/@MungaiBrianKE
